...
export function CartDrawer() {
  ...
  const { items, isLoading, updateQuantity, removeItem, createCheckout, clearCart } = useCartStore();
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full bg-card border-border">
        <SheetHeader className="flex-shrink-0">
          <SheetTitle className="font-cyber text-primary">Shopping Cart</SheetTitle>
          <SheetDescription>
